...
def EscapeString(*args, **kwargs):
    r"""EscapeString(int len, int scheme=CPLES_SQL) -> retStringAndCPLFree *"""
...
class Dataset(MajorObject):
    ...
    def SetGCPs(self, *args):
        r"""SetGCPs(Dataset self, int nGCPs, char const * pszGCPProjection) -> CPLErr"""
    ...
    def ReadRaster1(self, *args, **kwargs):
        r"""ReadRaster1(Dataset self, double xoff, double yoff, double xsize, double ysize, int * buf_xsize=None, int * buf_ysize=None, GDALDataType * buf_type=None, int band_list=0, GIntBig * buf_pixel_space=None, GIntBig * buf_line_space=None, GIntBig * buf_band_space=None, GDALRIOResampleAlg resample_alg=GRIORA_NearestNeighbour, GDALProgressFunc callback=0, void * callback_data=None) -> CPLErr"""
...
class MDArray(object):
    ...
    def AdviseRead(self, *args):
        r"""AdviseRead(MDArray self, int nDims1, int nDims2) -> CPLErr"""
    ...
    def GetGeoTransform(self, *args, **kwargs):
        r"""GetGeoTransform(MDArray self, int * can_return_null=None)"""
        return _gdal.MDArray_GetGeoTransform(self, *args, **kwargs)

    def IsIrregular(self, *args):
        r"""IsIrregular(MDArray self) -> bool"""
    ...
    def GetStatistics(self, *args, **kwargs):
        r"""GetStatistics(MDArray self, Dataset ds=None, bool approx_ok=FALSE, bool force=TRUE, GDALProgressFunc callback=0, void * callback_data=None) -> Statistics"""
        return _gdal.MDArray_GetStatistics(self, *args, **kwargs)

    def ComputeStatistics(self, *args, **kwargs):
        r"""ComputeStatistics(MDArray self, Dataset ds=None, bool approx_ok=FALSE, GDALProgressFunc callback=0, void * callback_data=None) -> Statistics"""
...
class Attribute(object):
    ...
    def Write(self, val):
      ...
      if isinstance(val, float):
        return self.WriteDouble(val)
      if isinstance(val, (str, type(''))) and self.GetDataType().GetClass() != GEDTC_COMPOUND:
...
class ExtendedDataType(object):
    ...
    def CreateString(*args):
        r"""CreateString(size_t nMaxStringLength=0) -> ExtendedDataType"""
...
def ExtendedDataType_CreateString(*args):
    r"""ExtendedDataType_CreateString(size_t nMaxStringLength=0) -> ExtendedDataType"""
    return _gdal.ExtendedDataType_CreateString(*args)
...
class Band(MajorObject):
    ...
    def WriteRaster(self, *args, **kwargs):
        r"""WriteRaster(Band self, int xoff, int yoff, int xsize, int ysize, GIntBig buf_len, int * buf_xsize=None, int * buf_ysize=None, int * buf_type=None, GIntBig * buf_pixel_space=None, GIntBig * buf_line_space=None) -> CPLErr"""
    ...
    def ReadRaster1(self, *args, **kwargs):
        r"""ReadRaster1(Band self, double xoff, double yoff, double xsize, double ysize, int * buf_xsize=None, int * buf_ysize=None, int * buf_type=None, GIntBig * buf_pixel_space=None, GIntBig * buf_line_space=None, GDALRIOResampleAlg resample_alg=GRIORA_NearestNeighbour, GDALProgressFunc callback=0, void * callback_data=None) -> CPLErr"""
        return _gdal.Band_ReadRaster1(self, *args, **kwargs)

    def ReadBlock(self, *args, **kwargs):
        r"""ReadBlock(Band self, int xoff, int yoff) -> CPLErr"""
...
def ApplyVerticalShiftGrid(*args, **kwargs):
    r"""ApplyVerticalShiftGrid(Dataset src_ds, Dataset grid_ds, bool inverse=False, double srcUnitToMeter=1.0, double dstUnitToMeter=1.0, char ** options=None) -> Dataset"""
...
def LoadGRIBTAB(*args):
    r"""LoadGRIBTAB(char const * pszFilename) -> int"""
...
def LookupGRIBTAB(*args):
    r"""LookupGRIBTAB(int nCode, int nCenter, int nSubCenter, int nTable) -> char **"""
    return _gdal.LookupGRIBTAB(*args)

def GetProjectionFromNetCDF(*args):
    r"""GetProjectionFromNetCDF(char const * pszUrl, char const * pszVarName, char const * pszFormat=None) -> retStringAndCPLFree *"""
    return _gdal.GetProjectionFromNetCDF(*args)

def IsCFCompatibleCRS(*args):
    r"""IsCFCompatibleCRS(SpatialReference poSRS) -> bool"""
...
def GetDriverByExtensionOrName(*args):
    r"""GetDriverByExtensionOrName(char const * ext) -> Driver"""
...
def OpenJSON(*args):
    r"""OpenJSON(char const * utf8_json, unsigned int nOpenFlags=0) -> Dataset"""
