...
ALLOWED_CMAPS = ['Accent', 'Accent_r', 'Blues', 'Blues_r',
             ...
             'bone_r', 'brg', 'brg_r', 'bwr', 'bwr_r', 'cool', 'cool_r',
             ...
             'gray_r', 'hot', 'hot_r', 'hsv', 'hsv_r', 'inferno',
             ...
             'winter_r']
###########################################################################
_CMAP_LOOKUP = dict(zip([c.lower() for c in ALLOWED_CMAPS],
                    ALLOWED_CMAPS))
###########################################################################
_SYMBOL_TYPES = {
...
def create_symbol(geometry_type,
    ...
    **Argument**          **Description**
    ...
    if symbol_type.lower() == 'simple': # Default Simple Symbol
        ...
        return symbol
    elif symbol_type == 'picture' and \
         geometry_type.lower() in ['multipoint',
                                   'point',
                                   'polygon']:
        if geometry_type.lower() in ['point', 'multipoint']:
            symbol = {
        ...
        return symbol
         ...
         geometry_type.lower() not in ['point', 'multipoint']:
        raise Exception("Text symbology is only supported by points and multipoints")
    elif symbol_type.lower() == 'carto' and \
         geometry_type in ['line', 'polyline']:
