...
class SiteManager(object):
    ...
    #----------------------------------------------------------------------
    def __init__(self, url, mission, gis):
        """Constructor"""
        self._url = url
        self._nb = mission
        gis = mission._gis
    ...
    def export_site(self, location):
        ...
        essential information about the ArcGIS Mission Server site and its
        machines.
    ...
    def import_site(self,
        ...
        your ArcGIS Mission Server site's configuration store with the
