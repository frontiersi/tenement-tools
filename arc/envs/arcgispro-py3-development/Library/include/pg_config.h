...
#define PG_VERSION_STR "PostgreSQL 12.3, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
...
#define VAL_CONFIGURE "--enable-thread-safety --with-ldap --with-openssl --with-libxml --with-libxslt --with-gssapi"
